...
"[project]/src/components/ThemeRegistry.tsx (client reference/proxy) <module evaluation>": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/components/ThemeRegistry.tsx (client reference/proxy)": ((__turbopack_context__) => {
"use strict";
...
var { g: global, __dirname } = __turbopack_context__;
{
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ThemeRegistry$2e$tsx__$28$client__reference$2f$proxy$29$__$3c$module__evaluation$3e$__ = __turbopack_context__.i("[project]/src/components/ThemeRegistry.tsx (client reference/proxy) <module evaluation>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ThemeRegistry$2e$tsx__$28$client__reference$2f$proxy$29$__ = __turbopack_context__.i("[project]/src/components/ThemeRegistry.tsx (client reference/proxy)");
;
__turbopack_context__.n(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ThemeRegistry$2e$tsx__$28$client__reference$2f$proxy$29$__);
}}),
...
function RootLayout({ children }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const isLoggedIn = "undefined" !== 'undefined' && localStorage.getItem('isLoggedIn') === 'true';
        // If logged in, block access to login/register
        if (isLoggedIn && (pathname.startsWith('/login') || pathname.startsWith('/register'))) {
            "TURBOPACK unreachable";
        }
        // If not logged in, block access to dashboard/features
        if (!isLoggedIn && (pathname.startsWith('/dashboard') || pathname.startsWith('/compose') || pathname.startsWith('/inbox') || pathname.startsWith('/keys') || pathname.startsWith('/test'))) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0799bdd9._.js.map