...
function LoginPage() {
    ...
    const handleLogin = async ()=>{
        ...
        setLoginInputError('');
        try {
            let loginType = loginInput.includes('@') ? 'email' : 'username';
            const success = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ApiClient"].login(loginInput, password, loginType);
            if (success) {
                // Set auth state (localStorage or context)
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6d3da815._.js.map