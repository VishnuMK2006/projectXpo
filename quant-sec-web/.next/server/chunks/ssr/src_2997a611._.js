...
class RealKyber {
    ...
    static async decrypt(tag, concatenated_string, username) {
        ...
        const userData = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["UserStorage"].getUserData();
...
function InboxPage() {
    ...
    const [showBody, setShowBody] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])({});
    ...
    const fetchEmails = async (user)=>{
        ...
        setError(null);
        try {
            const encryptedEmails = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ApiClient"].getInbox(user.username, user.password);
            ...
            for (const [index, email] of encryptedEmails.entries()){
                try {
                    ...
                    const decryptedSubject = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$crypto$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["decrypt"])(encryptedSubject.tag, encryptedSubject.concatenated_string, user.username);
                    const decryptedBody = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$crypto$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["decrypt"])(encryptedBody.tag, encryptedBody.concatenated_string, user.username);
    ...
    const handleClearInbox = async ()=>{
        ...
        setLoading(true);
        try {
            const success = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ApiClient"].clearInbox(userData.username, userData.password);
            if (success) {
                setEmails([]);
            } else {
...
//# sourceMappingURL=src_2997a611._.js.map