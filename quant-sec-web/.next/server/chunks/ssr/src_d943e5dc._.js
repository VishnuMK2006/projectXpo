...
function TestPage() {
    ...
    const runTests = async ()=>{
        ...
        try {
            ...
            const keyPair = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$crypto$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["RealKyber"].keygen();
            ...
            const encrypted = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$crypto$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CryptoUtils"].aesEncrypt(testMessage, 'test-key');
            const decrypted = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$crypto$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CryptoUtils"].aesDecrypt(encrypted, 'test-key');
            ...
            const hash = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$crypto$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CryptoUtils"].sha256('test');
            setTestResult((prev)=>prev + `   ✓ SHA-256 hash generated: ${hash.substring(0, 20)}...\n`);
            // Test 4: Random bytes
            setTestResult((prev)=>prev + '4. Testing random bytes...\n');
            const randomBytes = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$crypto$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CryptoUtils"].randomBytes(32);
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["UserStorage"].storeUserData(testUserData);
            const testMessage2 = 'Hello, Quantum World!';
            const encryptedData = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$crypto$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["RealKyber"].encrypt(testMessage2, keyPair.publicKey);
            const decryptedMessage = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$crypto$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["RealKyber"].decrypt(encryptedData.tag, encryptedData.concatenated_string, 'testuser');
            setTestResult((prev)=>prev + `   ✓ Kyber encryption/decryption: ${testMessage2 === decryptedMessage ? 'PASS' : 'FAIL'}\n`);
            // Clean up test data
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["UserStorage"].clearUserData();
...
//# sourceMappingURL=src_d943e5dc._.js.map